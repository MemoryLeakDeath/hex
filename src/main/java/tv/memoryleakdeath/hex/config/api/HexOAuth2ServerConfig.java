...
@Configuration
@EnableWebSecurity
public class HexOAuth2ServerConfig {
    ...
    public SecurityFilterChain oauth2ServerFilterChain(HttpSecurity http) throws Exception {
        ...
        http.exceptionHandling((exceptions) -> exceptions.defaultAuthenticationEntryPointFor(
                new LoginUrlAuthenticationEntryPoint("/loginminimal"),
                new MediaTypeRequestMatcher(MediaType.TEXT_HTML)))
                .oauth2ResourceServer((resource) -> resource.jwt(Customizer.withDefaults()));
        return http.build();
    }

    private Customizer<OAuth2AuthorizationEndpointConfigurer> authorizationEndpointConfig() {
        return auth -> auth.consentPage("/oauth2/consent");
    }
